...
class Questionnaire(models.Model):
    ...
    redirect_url = models.CharField(max_length=128, null=True, blank=True, help_text="URL to redirect to when Questionnaire is complete. Macros: $SUBJECTID, $RUNID, $LANG", default="/static/complete.html")
